...
<div class="w-full flex flex-row justify-end pr-[20%] z-10">
    <h1 class=" text-black-700 font-lily_script md:text-8xl pt-5 text-5xl text-sky-200 hover:underline hover:cursor-pointer"><a href="/auth/signup">in Snippets.</a></h1>
</div>
