...
<div class="z-10">
    <h1 class="text-black-700 font-eagle text-7xl text-black">Write your life</h1>
</div>

<div class="w-full flex flex-row justify-end pr-[20%] z-10">
    <h1 class=" text-black-700 font-lily_script text-8xl pt-5 text-sky-200 hover:underline hover:cursor-pointer"><a href="/">in Snippets.</a></h1>
</div>
